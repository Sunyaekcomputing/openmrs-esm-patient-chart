"use strict";
(globalThis["webpackChunk_openmrs_esm_home_app"] = globalThis["webpackChunk_openmrs_esm_home_app"] || []).push([["src_page-header_page-header_component_tsx"],{
...
/* harmony import */ var _openmrs_esm_patient_common_lib__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @openmrs/esm-patient-common-lib */ "./node_modules/@openmrs/esm-patient-common-lib/src/index.ts");
...
function HomePageHeader(param) {
    ...
    var _useState3 = _sliced_to_array((0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(""), 2), identifier = _useState3[0], setIdentifier = _useState3[1];
    var _useState4 = _sliced_to_array((0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(null), 2), searchResult = _useState4[0], setSearchResult = _useState4[1];
            ...
            return _ts_generator(this, function(_state) {
                switch(_state.label){
                    case 0:
                        ...
                        return [
                            4,
                            fetch("/openmrs/ws/rest/v1/patient?q=".concat(identifier, "&v=full"))
                        ];
                    case 1:
                        res = _state.sent();
                        return [
                    ...
                    case 2:
                        ...
                        if (data.results.length === 1) {
                            setSearchResult({
                                found: true,
                                name: data.results[0].person.display
                            });
                        } else {
                            setSearchResult({
                                found: false
    ...
    var openChart = function(patient) {
        return _async_to_generator(function() {
            return _ts_generator(this, function(_state) {
                switch(_state.label){
                    case 0:
                        ...
                        // 1️⃣ Navigate to Patient Chart
                        (0,_openmrs_esm_framework__WEBPACK_IMPORTED_MODULE_1__.navigate)({
                            to: "".concat(baseUrl, "/patient/").concat(patient.id, "/chart")
                        });
                        // 2️⃣ Give React + Patient Chart time to mount WorkspaceContainer
                        return [
                            4,
                    ...
                    case 1:
                        _state.sent();
                        // 3️⃣ Launch the ACTUAL registered workspace (NOT a string)
                        (0,_openmrs_esm_framework__WEBPACK_IMPORTED_MODULE_1__.launchWorkspace)(_openmrs_esm_patient_common_lib__WEBPACK_IMPORTED_MODULE_2__.formEntryWorkspace, {
    ...
    return /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, userRoles.includes("self registration") ? /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
        style: {
            display: "flex",
        ...
        value: identifier,
        onChange: function(e) {
            return setIdentifier(e.target.value.trim());
        },
        style: {
            width: "100%",
            padding: "1rem",
    ...
    }, "\uD83D\uDD0D Search Patient"), (searchResult === null || searchResult === void 0 ? void 0 : searchResult.found) === true && /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
        style: {
            marginTop: "20px",
            fontSize: "1.1rem",
            fontWeight: "600",
    ...
    }, "✅ Patient Found: ", searchResult.name), (searchResult === null || searchResult === void 0 ? void 0 : searchResult.found) === false && /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
        style: {
            marginTop: "20px",
            fontSize: "1.1rem",
            fontWeight: "600",
    ...
    }, "❌ Patient not registered"))), /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
        style: {
            display: "flex",
            justifyContent: "center",
            marginTop: "100px"
...
//# sourceMappingURL=src_page-header_page-header_component_tsx.js.map